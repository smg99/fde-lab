...
```text
        ...
        ┌─────────────────────┼─────────────────────┐
        │                     │                     │
⚡ Frontend Performance Lab   🎫 Ticket Flow    🔬 FDE Lab
        │
        ▼
...
A collection of open-source, production-style AI engineering Proofs-of-Concept designed to demonstrate Forward Deployed Engineering (FDE) skills.

### Highlights

- Incident Engineer (AI incident investigation)
- Integration Engineer (AI schema mapping & transformation)
- Thin Node.js CLI bootstrap
- Isolated Python Agent runtime
- Local deterministic data processing

**Tech**

TypeScript • Python • AI Agents • NPX • FDE
